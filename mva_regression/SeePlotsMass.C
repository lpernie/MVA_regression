...
void SeePlotsMass(TString NameWeightTest, TString NameWeight1, TString NameWeight2 ,bool isEta){
    ...
    Float_t Mass_pi0, Mass_pi0_corr, s4s9_1, s4s9_2, GaPt_1, GaPt_2, E3x3MC1, E3x3MC2, E3x31, E3x32;
    Int_t xtal_1, xtal_2;
    ...
    //Basic Cut
    const TCut *traincut = new TCut("cut","(E3x3MC1/E3x31)<3.0 && (E3x3MC2/E3x32)<3.0 && E3x32>0.01 && E3x3MC2>0.01 && E3x31>0.01 && E3x3MC1>0.01 && GaPt_1>0.55 && GaPt_2>0.55 && xtal_1>7 && xtal_2>5 && s4s9_1>0.75 &&  s4s9_2>0.75");
